...
基本的に弄るのはcatalog.ymlとconfig.ymlです。
config.ymlのtexstyleで出てくるtechbooster-doujinは
@<href>{https://github.com/TechBooster/C89-FirstStepReVIEW-v2/tree/master}
のarticles/styを参照する必要があると思います。(未検証)


以下は@<href>{https://github.com/TechBooster/C89-FirstStepReVIEW-v2/blob/master/articles/configure.re}より引用
